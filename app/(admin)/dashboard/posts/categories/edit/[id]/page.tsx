...
import getCategory, { getPostCategory } from "@/actions/get-category";
...
const EditPostCategory = ({ params }: EditPostCategoryProps) => {
  ...
  const handleClick = async () => {
    ...
    axios
      .post(
        `${process.env.NEXT_PUBLIC_BACKEND_API_URL}post/categories/${params.id}/edit`,
        newForm,
        {
          headers: {
